...
static void loadMainMenu()
{
	...
	player_1->AddComponent<graphics::TextureComponent>()->SetTexture( "starfighter.png" );
	...
	auto pPlayer_observer = player_1_lives_UI->AddComponent<UIValueObserver>( events::GameEvent{ core::make_sdbm_hash( "PlayerDied" ) }, [] ( int v ) {
	...
	pPlayer_observer = player_2_lives_UI->AddComponent<UIValueObserver>( events::GameEvent{ core::make_sdbm_hash( "PlayerDied" ) }, [] ( int v ) {
	...
	pPlayer_observer = player_2_score_UI->AddComponent<UIValueObserver>( events::GameEvent{ core::make_sdbm_hash( "ScoreChanged" ) }, [] ( int v ) {
